...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mZoom = (ImageView) findViewById(R.id.iv_zoom);
    ...
    public void onClick(View v) {
        if (mListener != null) {
            if (v == mThumbnail) {
                ...
                mListener.onZoomClicked(mMedia, mPreBindInfo.mViewHolder);
            }
        }
    }
    ...
    public interface OnMediaGridClickListener {
        ...
        void onZoomClicked(Item item, RecyclerView.ViewHolder holder);
    }
