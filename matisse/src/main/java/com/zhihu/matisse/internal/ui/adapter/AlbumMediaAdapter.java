...
public class AlbumMediaAdapter extends
    ...
    @Override
    public void onZoomClicked(Item item, RecyclerView.ViewHolder holder) {

        if (mOnMediaClickListener != null) {
            mOnMediaClickListener.onZoomClicked(null, item, holder.getAdapterPosition());
        }
...
//        }
    ...
    public interface OnMediaClickListener {
        ...
        void onZoomClicked(Album album, Item item, int adapterPosition);
